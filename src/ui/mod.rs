...
use crate::{
    ...
    ui::{
        home::render_home_screen, output::render_output_screen, trace::render_trace_screen,
        vars::render_vars_screen,
    },
};
...
pub fn draw_ui(app: &mut App, frame: &mut Frame) {
    ...
    match app.screen() {
        ...
        Screen::Trace => render_trace_screen(app, frame, body_area),
